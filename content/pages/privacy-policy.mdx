...
description: Privacy policy for Shop Studio
created_at: 2025-10-24
---

## Introduction

Welcome to Shop Studio, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At Shop Studio, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Shop Studio:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use Shop Studio, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Shop Studio, such as device type, operating system, and browser type.
...
By using Shop Studio, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
